...
export type State = {
  ...
  build: typeof BUILD,
  authState: AuthState,
  hiddenPinnedMessages: {[peerId: PeerId]: number},    settings: {
      messagesTextSize: number,
      distanceUnit: 'kilometers' | 'miles',
      autoAIReply: boolean,
      autoAIReplyAgent: 'professional' | 'friendly' | 'concise' | 'custom',
      customAIReplyAgent?: string,
...
export const STATE_INIT: State = {
  ...
  hiddenPinnedMessages: {},    settings: {
      messagesTextSize: 16,
      distanceUnit: 'kilometers',
      autoAIReply: false, // This setting will control auto-replies
      autoAIReplyAgent: 'professional' as const, // Default agent type
    sendShortcut: 'enter',
    autoDownload: {
      photo: {
        contacts: true,
