...
import appAutoReplyManager from './appAutoReplyManager';
...
export default function createManagers(appStoragesManager: AppStoragesManager, userId: UserId) {
  const managers = {
    ...
    appAutoReplyManager: appAutoReplyManager
  };
  ...
  names.unshift(
    ...
    'appMessagesManager',
    'dialogsStorage',
    'appAutoReplyManager'  // Make sure it's initialized after core managers
  );
